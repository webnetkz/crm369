...
<template>
                ...
                <div class="grid gap-3 lg:grid-cols-2">
                    ...
                    <div class="grid gap-2">
                        ...
                        <textarea
                            ...
                            readonly
                            :value="
                                authorizationHeaderValue(issuedWebhook.token)
                            "
                        ></textarea>
                    </div>
    ...
    <div class="space-y-8">
        ...
        <div
            class="grid gap-6 xl:grid-cols-[300px_minmax(0,1fr)] xl:items-start"
        >
            <aside class="space-y-4 xl:sticky xl:top-24">
                ...
                <section class="rounded-2xl border border-border bg-card p-4">
                    ...
                    <div class="mt-4 grid gap-2">
                        ...
                        <a
                            :href="`#${createSectionId}`"
                            class="rounded-xl border border-transparent px-3 py-2 text-sm text-muted-foreground transition-colors hover:border-border hover:bg-muted hover:text-foreground"
                        >
                            {{ t.webhooks.create_title }}
                        </a>
                    </div>
            ...
            <div class="space-y-8">
                ...
                >
                    <Heading
                        variant="small"
                        :title="t.webhooks.existing_title"
                    />
                    ...
                    >
                        ...
                        >
                            <Button
                                type="button"
                                :disabled="
                                    savingWebhookId === selectedWebhook.id
                                "
                ...
                >
                    ...
                    <form class="space-y-5" @submit.prevent="submitCreate">
                        ...
                        <div class="space-y-3">
                            ...
                            <InputError
                                :message="createForm.errors.permissions"
                            />
                        </div>
