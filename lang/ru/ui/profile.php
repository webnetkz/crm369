...
return [
    'avatar' => 'Аватар',
    'avatar_help' => 'Загрузите PNG, JPG, JPEG или WebP до 2 МБ, затем настройте положение изображения в круге.',
    'delete_account' => 'Удалить аккаунт',
    'email_unverified' => 'Ваша электронная почта не подтверждена.',
    'name' => 'Имя',
